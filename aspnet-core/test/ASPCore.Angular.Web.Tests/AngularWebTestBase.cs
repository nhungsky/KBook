...
{
    public abstract class AngularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AngularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AngularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AngularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AngularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AngularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AngularDbContext, Task<T>> func)
        {
            T result;
